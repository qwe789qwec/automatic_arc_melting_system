...
static const _CobottaBcap_Request_type_support_symbol_names_t _CobottaBcap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tcp_format, srv, CobottaBcap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tcp_format, srv, CobottaBcap_Request)),
  }
};
...
{
  return &::tcp_format::srv::rosidl_typesupport_cpp::CobottaBcap_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tcp_format, srv, CobottaBcap_Request)() {
  return get_message_type_support_handle<tcp_format::srv::CobottaBcap_Request>();
}
...
static const _CobottaBcap_Response_type_support_symbol_names_t _CobottaBcap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tcp_format, srv, CobottaBcap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tcp_format, srv, CobottaBcap_Response)),
  }
};
...
{
  return &::tcp_format::srv::rosidl_typesupport_cpp::CobottaBcap_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tcp_format, srv, CobottaBcap_Response)() {
  return get_message_type_support_handle<tcp_format::srv::CobottaBcap_Response>();
}
...
static const _CobottaBcap_type_support_symbol_names_t _CobottaBcap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tcp_format, srv, CobottaBcap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tcp_format, srv, CobottaBcap)),
  }
};
...
{
  return &::tcp_format::srv::rosidl_typesupport_cpp::CobottaBcap_service_type_support_handle;
}
