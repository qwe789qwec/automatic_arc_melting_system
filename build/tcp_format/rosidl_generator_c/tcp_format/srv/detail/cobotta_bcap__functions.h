...
#ifndef TCP_FORMAT__SRV__DETAIL__COBOTTA_BCAP__FUNCTIONS_H_
#define TCP_FORMAT__SRV__DETAIL__COBOTTA_BCAP__FUNCTIONS_H_
...
/// Initialize srv/CobottaBcap message.
/**
...
/// Finalize srv/CobottaBcap message.
/**
...
/// Create srv/CobottaBcap message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tcp_format__srv__CobottaBcap_Request__init().
...
/// Destroy srv/CobottaBcap message.
/**
 * It calls
 * tcp_format__srv__CobottaBcap_Request__fini()
...
/// Initialize array of srv/CobottaBcap messages.
/**
...
/// Finalize array of srv/CobottaBcap messages.
/**
 * It calls
 * tcp_format__srv__CobottaBcap_Request__fini()
...
/// Create array of srv/CobottaBcap messages.
/**
 * It allocates the memory for the array and calls
 * tcp_format__srv__CobottaBcap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CobottaBcap messages.
/**
 * It calls
 * tcp_format__srv__CobottaBcap_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tcp_format__srv__CobottaBcap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tcp_format
...
/**
 * It calls
 * tcp_format__srv__CobottaBcap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tcp_format
...
/**
 * It allocates the memory for the array and calls
 * tcp_format__srv__CobottaBcap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tcp_format
...
/**
 * It calls
 * tcp_format__srv__CobottaBcap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TCP_FORMAT__SRV__DETAIL__COBOTTA_BCAP__FUNCTIONS_H_
