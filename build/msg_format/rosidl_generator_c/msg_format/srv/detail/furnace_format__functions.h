...
#ifndef MSG_FORMAT__SRV__DETAIL__FURNACE_FORMAT__FUNCTIONS_H_
#define MSG_FORMAT__SRV__DETAIL__FURNACE_FORMAT__FUNCTIONS_H_
...
/// Initialize srv/FurnaceFormat message.
/**
...
/// Finalize srv/FurnaceFormat message.
/**
...
/// Create srv/FurnaceFormat message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * msg_format__srv__FurnaceFormat_Request__init().
...
/// Destroy srv/FurnaceFormat message.
/**
 * It calls
 * msg_format__srv__FurnaceFormat_Request__fini()
...
/// Initialize array of srv/FurnaceFormat messages.
/**
...
/// Finalize array of srv/FurnaceFormat messages.
/**
 * It calls
 * msg_format__srv__FurnaceFormat_Request__fini()
...
/// Create array of srv/FurnaceFormat messages.
/**
 * It allocates the memory for the array and calls
 * msg_format__srv__FurnaceFormat_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/FurnaceFormat messages.
/**
 * It calls
 * msg_format__srv__FurnaceFormat_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * msg_format__srv__FurnaceFormat_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_format
...
/**
 * It calls
 * msg_format__srv__FurnaceFormat_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_format
...
/**
 * It allocates the memory for the array and calls
 * msg_format__srv__FurnaceFormat_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_format
...
/**
 * It calls
 * msg_format__srv__FurnaceFormat_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MSG_FORMAT__SRV__DETAIL__FURNACE_FORMAT__FUNCTIONS_H_
