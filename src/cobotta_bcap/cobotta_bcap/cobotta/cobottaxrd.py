...
P20 intermediate between 10 and 21
P21 stock position for xrdplate

P22 intermediate between 10 and 23
P23 intermediate between 22 and 24
P24 xrd plate for xrdmachine
...
class cobottaxrd:
    ...
    TASK_INIT = "init"
    TASK_TAKE_PLATEXRD = "take_platexrd"
    TASK_PUT_PLATEXRD = "put_platexrd"
    TASK_TAKE_PLATESTOCK = "take_platestock"
    TASK_PUT_PLATESTOCK = "put_platestock"
    ...
    def make_action(self, step):
        command = get_command(step, "cobottaxrd")
        action = "none"
