#ifndef SLIDERXRD_HPP
#define SLIDERXRD_HPP
...
{
public:
    sliderxrd(std::string ip, int port);
    ~sliderxrd();
...
private:
    ...
    static constexpr const int XRD_POS = 549000; // sliderxrd position for xrd machine, 550.000 mm
