...
msg_format__srv__SliderFormat_Request__init(msg_format__srv__SliderFormat_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->action)) {
    msg_format__srv__SliderFormat_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  msg_format__srv__SliderFormat_Request * msg = (msg_format__srv__SliderFormat_Request *)malloc(sizeof(msg_format__srv__SliderFormat_Request));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(msg_format__srv__SliderFormat_Request));
  bool success = msg_format__srv__SliderFormat_Request__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
msg_format__srv__SliderFormat_Request__Sequence__init(msg_format__srv__SliderFormat_Request__Sequence * array, size_t size)
{
  ...
  msg_format__srv__SliderFormat_Request * data = NULL;
  if (size) {
    data = (msg_format__srv__SliderFormat_Request *)calloc(size, sizeof(msg_format__srv__SliderFormat_Request));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = msg_format__srv__SliderFormat_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        msg_format__srv__SliderFormat_Request__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
msg_format__srv__SliderFormat_Request__Sequence__fini(msg_format__srv__SliderFormat_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      msg_format__srv__SliderFormat_Request__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  msg_format__srv__SliderFormat_Request__Sequence * array = (msg_format__srv__SliderFormat_Request__Sequence *)malloc(sizeof(msg_format__srv__SliderFormat_Request__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = msg_format__srv__SliderFormat_Request__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    msg_format__srv__SliderFormat_Request__Sequence__fini(array);
  }
  free(array);
}
...
msg_format__srv__SliderFormat_Response__init(msg_format__srv__SliderFormat_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->result)) {
    msg_format__srv__SliderFormat_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  msg_format__srv__SliderFormat_Response * msg = (msg_format__srv__SliderFormat_Response *)malloc(sizeof(msg_format__srv__SliderFormat_Response));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(msg_format__srv__SliderFormat_Response));
  bool success = msg_format__srv__SliderFormat_Response__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
msg_format__srv__SliderFormat_Response__Sequence__init(msg_format__srv__SliderFormat_Response__Sequence * array, size_t size)
{
  ...
  msg_format__srv__SliderFormat_Response * data = NULL;
  if (size) {
    data = (msg_format__srv__SliderFormat_Response *)calloc(size, sizeof(msg_format__srv__SliderFormat_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = msg_format__srv__SliderFormat_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        msg_format__srv__SliderFormat_Response__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
msg_format__srv__SliderFormat_Response__Sequence__fini(msg_format__srv__SliderFormat_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      msg_format__srv__SliderFormat_Response__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  msg_format__srv__SliderFormat_Response__Sequence * array = (msg_format__srv__SliderFormat_Response__Sequence *)malloc(sizeof(msg_format__srv__SliderFormat_Response__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = msg_format__srv__SliderFormat_Response__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    msg_format__srv__SliderFormat_Response__Sequence__fini(array);
  }
  free(array);
}
