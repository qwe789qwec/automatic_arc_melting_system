...
#ifndef TCP_FORMAT__SRV__DETAIL__SOCKET_MESSAGE__TYPE_SUPPORT_H_
#define TCP_FORMAT__SRV__DETAIL__SOCKET_MESSAGE__TYPE_SUPPORT_H_
...
#endif  // TCP_FORMAT__SRV__DETAIL__SOCKET_MESSAGE__TYPE_SUPPORT_H_
